	...
	<div class=" min-h-screen py-4 bg-black text-white">
		...
		<div class="mx-auto mt-10 flex flex-col md:flex-row">
			<div class="flex flex-col w-full lg:w-3/5 p-8">
				...
				</h1><span className=" text-l">Al igual que un entrenamiento de crossfit,</span>
				<div class="font-sans text-sm md:text-lg my-2 md:my-4">combinamos diferentes disciplinas para alcanzar el éxito. Nos especializamos en levantar bases de datos y hacer sentadillas con HTML y CSS. Con nosotros, tu sitio web estará en la mejor forma. <br></br>
