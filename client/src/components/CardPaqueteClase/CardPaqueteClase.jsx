...
const CardPaquete = ({ title, clases, price, comprar, description }) => {
  ...
  const handleModalLogin = () => {
    ...
    return (
        ...
        <div class="bg-cover px-6 py-12  bg-gray hover:shadow-gray-claro rounded-lg shadow-md" style={{ backgroundImage: `url(${backgroundImage})` }}>
                    <p class="text-xl font-semibold text-black">{title}</p>
