...
const Nav = () => {
  ...
  return (
    <nav className="flex fixed justify-between z-50 bg-black text-white w-screen">
      <div className="px-5 xl:px-12 py-3 flex w-full items-center">
        ...
        <ul
          className={`md:flex uppercase md:items-center px-6 mx-auto font-poppins font-heading z-[-1] md:z-auto md:static absolute left-0 w-full md:w-auto md:py-0 py-10 md:pl-0 pl-7 md:opacity-100  top[-400px] transition-all ease-in duration-500 ${
        ...
        >
          ...
          <li className="mx-4 my-6 md:my-0">
            <Link
              ...
              to="/admin"
            >
              <button className=" bg-green-neon text-right uppercase text-black cursor-pointer rounded-xl px-4 py-2 text-sm text-gray-700 hover:bg-green.claro">
                Dashboard Admin
              </button>
            </Link>
          </li>
